...
@Repository
public interface ReactiveDriverEventRepository extends ReactiveMongoRepository<DriverEvent, String> {
  
    
    
	
	Mono<DriverEvent> findByDriverId(String id);
	
	@Tailable
	Flux<DriverEvent> findWithTailableCursorByDriverId(String id);
